...
export class Register extends BasePage{
    ...
    get agree_radio(){return this.page.locator("label[for='input-agree']")}
    get continue_btn(){return this.page.locator("input[type='submit']")}
    userInputField(field: any) { return this.page.locator(`input#${field}`) }
